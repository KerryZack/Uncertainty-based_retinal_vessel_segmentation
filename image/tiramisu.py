...
class FCDenseNet(nn.Module):
	def __init__(self, in_channels=3, down_blocks=(5, 5, 5, 5, 5),
		...
		self.finalConv1 = nn.Conv2d(in_channels=cur_channels_count,
	...
	#        out_channels=n_classes, kernel_size=1, stride=1,
	#            padding=0, bias=True)
	# self.softmax = nn.Softmax(dim=1)   #原来是logsoftmax
	...
	def forward(self, x):
		...
		mu = self.finalConv1(out)
		# sigma2=self.finalConv2(out)
		# mu=self.softmax(mu)
		# out = self.softmax(out)
		# mu=torch.log(1+mu)
		# sigma2=torch.log(1+sigma2)
